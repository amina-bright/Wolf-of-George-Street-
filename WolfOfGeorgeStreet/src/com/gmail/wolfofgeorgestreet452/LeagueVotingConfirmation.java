 ...
 */
@WebServlet("/LeagueVotingConfirmation")
public class LeagueVotingConfirmation extends HttpServlet {
     ...
     */
    public LeagueVotingConfirmation() {
        super();
    }
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		request.getRequestDispatcher("/jsps/LeagueVotingConfirmation.jsp").forward(request, response);
	}//transfers to league voting confirmation page
