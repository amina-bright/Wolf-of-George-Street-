 ...
 */
@WebServlet("/LeagueVotingConcludeConfirmation")
public class LeagueVotingConcludeConfirmation extends HttpServlet {
     ...
     */
    public LeagueVotingConcludeConfirmation() {
        super();
    }
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		request.getRequestDispatcher("/jsps/LeagueVotingConcludeConfirmation.jsp").forward(request, response);
	}//transfers to voting confirmation page
