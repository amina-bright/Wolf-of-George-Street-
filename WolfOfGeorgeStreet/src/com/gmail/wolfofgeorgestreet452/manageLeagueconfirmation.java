 ...
 */
@WebServlet("/ManageLeagueConfirmation")
public class manageLeagueconfirmation extends HttpServlet {
     ...
     */
    public manageLeagueconfirmation() {
        super();
    }
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		request.getRequestDispatcher("/jsps/ManageLeagueConfirmation.jsp").forward(request, response);
